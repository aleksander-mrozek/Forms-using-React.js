...
const Form = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className={styles.containerForm} >
      ...
      <input id={styles.fullName} type="text" ref={fullNameRef} name="fullName" value={fullName} onChange={handleChange} />
      <ErrorWrapper ref={fullNameRefError} ></ErrorWrapper>
      <label htmlFor="email" >E-mail:</label>
      <input id={styles.email} type="text" ref={emailRef} name="email" value={email} onChange={handleChange} />
      <ErrorWrapper ref={emailRefError} ></ErrorWrapper>
      <label htmlFor="bio" >Provide more information about yourself:</label>
      <textarea id={styles.bio} rows="5" cols="30" ref={bioRef} name="bio" value={bio} onChange={handleChange} ></textarea>
      <ErrorWrapper ref={bioRefError} ></ErrorWrapper>
      <div>
        <input id="gender-male" type="radio" name="gender" checked={gender==="Male" ? true : false} value="Male" onChange={handleChange} />
        <label htmlFor="gender-male" >Male</label>
        <input id="gender-female" type="radio" name="gender" checked={gender==="Female" ? true : false} value="Female" onChange={handleChange} />
        <label htmlFor="gender-female" >Female</label>
      </div>
      <ErrorWrapper ref={genderErrorRef} ></ErrorWrapper>
      <div>
        <input id="terms" type="checkbox" ref={checkedRef} name="terms" checked={checkbox} onChange={(e) => setCheckbox(e.target.checked)} />
